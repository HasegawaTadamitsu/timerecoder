...
public final class PropertyDao {
     ...
     * @param db1
     */
    public PropertyDao(SQLiteDatabase db1) {
    ...
    public List<Integer> findAllGroupId() {
        ...
        Cursor c = this.db.query(TABLE_NAME, columns, null, // selection
                null, // selectionArgs
    ...
    public Map<String, String> findByGroupId(final int argGroupId) {
        ...
        String[] columns = {
                COLUMN_GROUP_ID, COLUMN_KEY, COLUMN_VALUE
        };

        Cursor c = this.db.query(TABLE_NAME, columns, COLUMN_GROUP_ID + " = "
                + argGroupId,
        // selection
                null, // selectionArgs
                null, // groupBy
