 ...
 * @author T.Hasegawa
 */
public final class RecodeActivity
    ...
    private void initWidget() {
        ...
        boolean useLocation = preferences.getBoolean(
                "recode_use_location", false);
    ...
    private MyLocation doRecodeLocation() {
        MyLocation location = recodeLocationMgr.getRecodeLocation();
        if (location == null) {
    ...
    public void onClick(final View v) {
        ...
        case R.id.button_start:
            rec = new Recode(categoryId, dateTime, Recode.EventId.START,
                    memo);
            break;
        case R.id.button_end:
            rec = new Recode(categoryId, dateTime, Recode.EventId.END,
                    memo);
            break;
        case R.id.button_etc:
            rec = new Recode(categoryId, dateTime, Recode.EventId.ETC,
                    memo);
            break;
        default:
            throw new IllegalArgumentException("unknown button(view).id["
                    + id + "]");
        }
