...
/**
 * GPS のみとする。
 * Wifi やら他の位置取得情報があるけど、使わない。
 */
public final class RecodeLocationMgr 
    ...
    /**
     *
     * @param argContext コンテキスト。ここからサービスを取得.
     * @param argWaitSecondTime 取得にあたって最大待つ時間。単位秒.
     */
	...
	final int intervalMilliSecondTime = 
	    locationTotalWaitSecondTime * 1000 //milli second
